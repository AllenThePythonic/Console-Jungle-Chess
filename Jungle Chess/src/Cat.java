...
public class Cat extends Animal {
	...
	/*-----Methods-----*/
	// Cat is a contructor which accepts 2 parameters, player and Position
	public Cat(int player, Position p) {
		super(player, p, "1 = Cat");
		this.player = player;
		this.p = p;
	}
	...
	// toString is a method which returns "C" and player number
