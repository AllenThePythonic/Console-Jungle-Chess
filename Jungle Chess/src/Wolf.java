...
public class Wolf extends Animal {
	...
	/*-----Methods-----*/
	// Wolf is a contructor which accepts 2 parameters, player and Position
	public Wolf(int player, Position p) {
		super(player, p, "2 = Wolf");
		this.player = player;
		this.p = p;
	}
	...
	// toString is a method which returns "W" and player number
