...
public class Dog extends Animal {
	...
	/*-----Methods-----*/
	// Dog is a contructor which accepts 2 parameters, player and Position
	public Dog(int player, Position p) {
		super(player, p, "3 = Dog");
		this.player = player;
		this.p = p;
	}
	...
	// toString is a method which returns "D" and player number
