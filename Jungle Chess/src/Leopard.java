//Leopard is a subclass of Animal
public class Leopard extends Animal {

	/*-----Methods-----*/
	// Leopard is a contructor which accepts 2 parameters, player and Position
	public Leopard(int player, Position p) {
		super(player, p, "4 = Leopard");
		this.player = player;
		this.p = p;
	}
	...
	// toString is a method which returns "P" and player number
